...
import { Check, ShieldAlert, ShieldCheck, X, Play, FlaskConical, ArrowRight, ScrollText, Globe } from "lucide-react";
...
function DecisionLog({ decisions }: { decisions?: any[] }) {
  return (
    <div className="space-y-3">
      <div>
